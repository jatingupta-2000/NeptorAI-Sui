...
export default tseslint.config(
	...
	// All files (JS and TS)
	{
		...
		rules: {
			...
			'local/code-no-dangerous-type-assertions': 'off', // Neptor warn -> off
			...
			// Neptor - this should only apply to workbench/void/
			// 'header/header': [
			// 	2,
			// 	'block',
			// 	[
	...
	// TS
	{
		...
		rules: {
			'@stylistic/ts/semi': 'off', // <-- Neptor
			'@stylistic/ts/member-delimiter-style': 'off', // <-- Neptor
			...
			'jsdoc/no-types': 'warn',
			'local/code-no-static-self-ref': 'off' // <-- Neptor
		}
	},
	// vscode TS
	{
