...
//#region --- Neptor
import './contrib/neptor/browser/neptor.contribution.js'; // Neptor added this
//#endregion
...
// Chat
// Neptor - this is still registered to avoid console errors, we just commented it out in chatParticipant.contribution.ts
