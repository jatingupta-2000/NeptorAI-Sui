...
// The extension this was called from is here - https://github.com/neptorai/neptor/blob/autocomplete/extensions/neptor/src/extension/extension.ts
...
export class AutocompleteService extends Disposable implements IAutocompleteService {
	...
	static readonly ID = 'neptor.autocompleteService'
