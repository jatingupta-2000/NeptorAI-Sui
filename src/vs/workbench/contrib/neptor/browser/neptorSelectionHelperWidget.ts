...
import { mountNeptorSelectionHelper } from './react/out/neptor-editor-widgets-tsx/index.js';
...
export type NeptorSelectionHelperProps = {
...
export class SelectionHelperContribution extends Disposable implements IEditorContribution, IOverlayWidget {
	public static readonly ID = 'editor.contrib.neptorSelectionHelper';
	// react
	...
	constructor(
		...
		@INeptorSettingsService private readonly _voidSettingsService: INeptorSettingsService
	) {
		super();
		...
		this._instantiationService.invokeFunction(accessor => {
			...
			const res = mountNeptorSelectionHelper(content, accessor);
			if (!res) return;
	...
	private _showHelperForSelection(selection: Selection): void {
		...
		if (enabled) {
			this._rerender({ rerenderKey: this._rerenderKey } satisfies NeptorSelectionHelperProps)
