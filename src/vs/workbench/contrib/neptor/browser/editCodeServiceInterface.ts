...
import { Diff, DiffArea, NeptorFileSnapshot } from '../common/editCodeServiceTypes.js';
...
export interface IEditCodeService {
	...
	// testDiffs(): void;
	getNeptorFileSnapshot(uri: URI): NeptorFileSnapshot;
	restoreNeptorFileSnapshot(uri: URI, snapshot: NeptorFileSnapshot): void;
}
