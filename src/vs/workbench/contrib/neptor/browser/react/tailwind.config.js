	...
	theme: {
		extend: {
			typography: theme => ({
				DEFAULT: {
					css: {
						'--tw-prose-body': 'var(--neptor-fg-1)',
						'--tw-prose-headings': 'var(--neptor-fg-1)',
						'--tw-prose-lead': 'var(--neptor-fg-2)',
						'--tw-prose-links': 'var(--neptor-link-color)',
						'--tw-prose-bold': 'var(--neptor-fg-1)',
						'--tw-prose-counters': 'var(--neptor-fg-3)',
						'--tw-prose-bullets': 'var(--neptor-fg-3)',
						'--tw-prose-hr': 'var(--neptor-border-4)',
						'--tw-prose-quotes': 'var(--neptor-fg-1)',
						'--tw-prose-quote-borders': 'var(--neptor-border-2)',
						'--tw-prose-captions': 'var(--neptor-fg-3)',
						'--tw-prose-code': 'var(--neptor-fg-0)',
						'--tw-prose-pre-code': 'var(--neptor-fg-0)',
						'--tw-prose-pre-bg': 'var(--neptor-bg-1)',
						'--tw-prose-th-borders': 'var(--neptor-border-4)',
						'--tw-prose-td-borders': 'var(--neptor-border-4)',
					},
				},
			}),
			fontSize: {
			...
			colors: {
				'neptor-bg-1': 'var(--neptor-bg-1)',
				'neptor-bg-1-alt': 'var(--neptor-bg-1-alt)',
				'neptor-bg-2': 'var(--neptor-bg-2)',
				'neptor-bg-2-alt': 'var(--neptor-bg-2-alt)',
				'neptor-bg-2-hover': 'var(--neptor-bg-2-hover)',
				'neptor-bg-3': 'var(--neptor-bg-3)',


				'neptor-fg-0': 'var(--neptor-fg-0)',
				'neptor-fg-1': 'var(--neptor-fg-1)',
				'neptor-fg-2': 'var(--neptor-fg-2)',
				'neptor-fg-3': 'var(--neptor-fg-3)',
				'neptor-fg-4': 'var(--neptor-fg-4)',

				'neptor-warning': 'var(--neptor-warning)',

				'neptor-border-1': 'var(--neptor-border-1)',
				'neptor-border-2': 'var(--neptor-border-2)',
				'neptor-border-3': 'var(--neptor-border-3)',
				'neptor-border-4': 'var(--neptor-border-4)',

				'neptor-ring-color': 'var(--neptor-ring-color)',
				'neptor-link-color': 'var(--neptor-link-color)',

				'neptor-accent-primary': 'var(--neptor-accent-primary)',
				'neptor-accent-primary-hover': 'var(--neptor-accent-primary-hover)',
				'neptor-accent-primary-light': 'var(--neptor-accent-primary-light)',
				'neptor-accent-primary-muted': 'var(--neptor-accent-primary-muted)',
