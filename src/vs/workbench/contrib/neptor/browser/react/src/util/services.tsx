...
import { MCPUserState, RefreshableProviderName, SettingsOfProvider } from '../../../../../../../workbench/contrib/neptor/common/neptorSettingsTypes.js'
import { DisposableStore, IDisposable } from '../../../../../../../base/common/lifecycle.js'
import { NeptorSettingsState } from '../../../../../../../workbench/contrib/neptor/common/neptorSettingsService.js'
import { ColorScheme } from '../../../../../../../platform/theme/common/theme.js'
import { RefreshModelStateOfProvider } from '../../../../../../../workbench/contrib/neptor/common/refreshModelService.js'
...
import { IPmWorkspaceBootstrapService } from '../../../../common/pmWorkspaceBootstrapService.js';
...
import { IRefreshModelService } from '../../../../../../../workbench/contrib/neptor/common/refreshModelService.js';
import { INeptorSettingsService } from '../../../../../../../workbench/contrib/neptor/common/neptorSettingsService.js';
import { IExtensionTransferService } from '../../../../../../../workbench/contrib/neptor/browser/extensionTransferService.js'
...
let settingsState: NeptorSettingsState
const settingsStateListeners: Set<(s: NeptorSettingsState) => void> = new Set()
...
export const _registerServices = (accessor: ServicesAccessor) => {
	...
	const stateServices = {
		...
		settingsStateService: accessor.get(INeptorSettingsService),
		refreshModelService: accessor.get(IRefreshModelService),
		themeService: accessor.get(IThemeService),
		editCodeService: accessor.get(IEditCodeService),
		neptorCommandBarService: accessor.get(INeptorCommandBarService),
		modelService: accessor.get(IModelService),
		mcpService: accessor.get(IMCPService),
	}

	const { settingsStateService, chatThreadsStateService, refreshModelService, themeService, editCodeService, neptorCommandBarService, modelService, mcpService } = stateServices
	...
	disposables.push(
		neptorCommandBarService.onDidChangeState(({ uri }) => {
			commandBarURIStateListeners.forEach(l => l(uri));
		})
	)

	disposables.push(
		neptorCommandBarService.onDidChangeActiveURI(({ uri }) => {
...
const getReactAccessor = (accessor: ServicesAccessor) => {
	const reactAccessor = {
		...
		INeptorSettingsService: accessor.get(INeptorSettingsService),
		...
		INeptorModelService: accessor.get(INeptorModelService),
		IWorkspaceContextService: accessor.get(IWorkspaceContextService),

		INeptorCommandBarService: accessor.get(INeptorCommandBarService),
		...
		INeptorProjectMemoryService: accessor.get(INeptorProjectMemoryService),
		IPmWorkspaceBootstrapService: accessor.get(IPmWorkspaceBootstrapService),
		IWorkspaceLifecycleService: accessor.get(IWorkspaceLifecycleService),
		INeptorOrganizationService: accessor.get(INeptorOrganizationService),
		INeptorOrgCollaborationService: accessor.get(INeptorOrgCollaborationService),
...
export const useAccessor = () => {
	if (!reactAccessor_) {
		throw new Error(`⚠️ Neptor useAccessor was called before _registerServices!`)
	}
