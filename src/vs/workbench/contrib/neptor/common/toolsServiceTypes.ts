...
export type BuiltinToolCallParams = {
	...
	'pm_memory_search': { query: string, maxHits: number },
	'pm_memory_read': { artifactType: string, sectionId: string | null },
	// ---
...
export type BuiltinToolResultType = {
	...
	'pm_memory_search': { text: string },
	'pm_memory_read': { text: string },
	// ---
