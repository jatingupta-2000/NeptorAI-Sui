...
import { NeptorSettingsState } from './neptorSettingsService.js'
...
export type NeptorStatefulModelInfo = { // <-- STATEFUL
	modelName: string,
...
type CommonProviderSettings = {
	...
	models: NeptorStatefulModelInfo[],
}
...
export const subTextMdOfProviderName = (providerName: ProviderName): string => {
	...
	if (providerName === 'googleVertex') return 'You must authenticate before using Vertex with Neptor. Read more about endpoints [here](https://cloud.google.com/vertex-ai/generative-ai/docs/multimodal/call-vertex-using-openai-library), and regions [here](https://cloud.google.com/vertex-ai/docs/general/locations#available-regions).'
...
const modelInfoOfDefaultModelNames = (defaultModelNames: string[]): { models: NeptorStatefulModelInfo[] } => {
	return {
...
export const isProviderNameDisabled = (providerName: ProviderName, settingsState: NeptorSettingsState) => {
...
export const isFeatureNameDisabled = (featureName: FeatureName, settingsState: NeptorSettingsState) => {
...
/** PM memory consolidation: aggressive runs after PM replies and code agent idle; pm_only skips code hook; manual disables hooks */
export type MemoryConsolidationMode = 'aggressive' | 'pm_only' | 'manual'
...
export type GlobalSettings = {
	...
	/** When true, inject a short PM memory summary into code chat system message (in addition to tool-based retrieval). */
	injectPmMemorySummaryInCodeChat: boolean;
}
...
export const defaultGlobalSettings: GlobalSettings = {
	...
	memoryConsolidationMode: 'aggressive',
	injectPmMemorySummaryInCodeChat: false,
}
