...
import { NEPTOR_OPEN_SETTINGS_ACTION_ID } from '../../neptor/browser/neptorSettingsPane.js';
...
MenuRegistry.appendMenuItem(MenuId.MenubarFileMenu, {
	...
	command: {
		...
		title: nls.localize({ key: 'openNeptor', comment: ['&& denotes a mnemonic'] }, "&&Open Neptor Settings"),
	},
	order: 1
});
