...
Neptor separately records basic usage like the number of messages people are sending. If you'd like to disable Neptor metrics, you may do so in Neptor's Settings.
`;
